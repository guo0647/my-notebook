...
\definecolor{accentteal}{HTML}{2A7F78}
\definecolor{softgray}{HTML}{F6F7F9}
\definecolor{rulegray}{HTML}{D8DEE8}
...
\hypersetup{
    ...
    pdfauthor={Game Theory and Strategy},
    pdftitle={MATH3911 Notes}
}
...
\setlist{itemsep=0.2em,topsep=0.35em,leftmargin=2.2em}
...
\pagestyle{fancy}
\fancyhf{}
\lhead{\textsc{MATH3911}}
\rhead{\textsc{Game Theory and Strategy}}
\cfoot{\thepage}
...
\newcommand{\note}[1]{%
    \begin{tcolorbox}[title=\textbf{Note},fonttitle=\bfseries,coltitle=textgray]
        #1
    \end{tcolorbox}
}

\title{\textbf{\Huge MATH3911}\\[0.35em]\Large Game Theory and Strategy}
\author{}
\date{May 6, 2026}
\begin{document}
...
\begin{titlepage}
    ...
    {\color{headingblue}\rule{0.75\textwidth}{0.8pt}\par}
    \vspace{1.2em}
    {\Huge\bfseries MATH3911\par}
    \vspace{0.55em}
    {\Large Game Theory and Strategy\par}
    \vspace{1.0em}
    {\large Lecture Notes\par}
    \vspace{1.2em}
    {\color{headingblue}\rule{0.75\textwidth}{0.8pt}\par}
    \vfill
    {\large May 6, 2026\par}
\end{titlepage}
